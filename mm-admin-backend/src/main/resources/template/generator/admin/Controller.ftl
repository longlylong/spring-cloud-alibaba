...
public class ${className}Controller {
    ...
    @PreAuthorize("@mm.check('${changeClassName}:list')")
    ...
    @PreAuthorize("@mm.check('${changeClassName}:add')")
    ...
    @PreAuthorize("@mm.check('${changeClassName}:edit')")
    ...
    @PreAuthorize("@mm.check('${changeClassName}:del')")
    @DeleteMapping
