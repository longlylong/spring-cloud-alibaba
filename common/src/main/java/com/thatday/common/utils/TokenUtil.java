...
public class TokenUtil {
    ...
    private static final long Order_Token_Expires = 60 * 60 * 1000;
    private static final String Secret = "fj!!7aa#@#@";
    ...
    public static String getOrderToken(Integer uid, String orderSerial, Integer payResult) {
        Map<String, Object> map = new HashMap<>();
        map.put("userId", uid);
        map.put("orderSerial", orderSerial);
        map.put("payResult", payResult);
        map.put("expireTime", new Date().getTime() + Order_Token_Expires);
