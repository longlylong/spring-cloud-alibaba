...
import com.thatday.tinyid.base.exception.TinyIdSysException;
import com.thatday.tinyid.base.service.SegmentIdService;
import com.thatday.tinyid.server.common.Constants;
import com.thatday.tinyid.server.dao.TinyIdInfoDAO;
import com.thatday.tinyid.server.dao.entity.TinyIdInfo;
    ...
    public SegmentId getNextSegmentId(String bizType) {
        ...
        for (int i = 0; i < retry; i++) {
            ...
            if (row == 1) {
                ...
                logger.debug("getNextSegmentId success tinyIdInfo:{} current:{}", tinyIdInfo, segmentId);
                return segmentId;
            } else {
